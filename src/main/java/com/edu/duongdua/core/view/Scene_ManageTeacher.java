...
public class Scene_ManageTeacher {
    ...
    public TableView<Account> teacherTable = new TableView<>();
    ...
    TableColumn<Account, String> salaryCol =  new TableColumn<>("Mức lương");
    TableColumn<Account, String> statusCol = new TableColumn<>("Trạng thái");

    public TableView<Bill> billTable = new TableView<>();
    TableColumn<Bill, String> billIdCol = new TableColumn<>("id");
    TableColumn<Bill, String> teacherIdCol = new TableColumn<>("id giáo viên");
    TableColumn<Bill, String> dateCol = new TableColumn<>("Tháng");
    TableColumn<Bill, String> lessonCountCol = new TableColumn<>("Số buổi");
    TableColumn<Bill, String> monthlySalaryCol = new TableColumn<>("Lương tháng");
    TableColumn<Bill, String> billStatusCol = new TableColumn<>("Trạng thái");
    TableColumn<Bill, String> updateCol = new TableColumn<>();

    public Scene_ManageTeacher() {
        createScene();
    }
    ...
    public void createScene(){
        ...
        Label label = new Label("DANH SÁCH GIÁO VIÊN");
        ...
        teacherTable.setId("TeacherTable");
        teacherTable.setOnMousePressed(event -> {
        ...
        billIdCol.setPrefWidth(30);
        teacherIdCol.setPrefWidth(120);
        dateCol.setPrefWidth(120);
        lessonCountCol.setPrefWidth(90);
        monthlySalaryCol.setPrefWidth(90);
        ...
        anchorPane.getChildren().addAll(hBox, teacherTable, addStackPane, billStackPane);
    }
...
//        vBox8.setPadding(new Insets(0,0,0,15));
        ...
        hBox2.getChildren().addAll(vBox6, vBox7);
...
//        vBox12.setPadding(new Insets(0,0,0,15));
        ...
        Label label10 = new Label("Bằng cấp");
        label10.setFont(Font.font("System", FontWeight.NORMAL, 20));
        certificatesTextField.setPrefHeight(59);
        VBox vBox11 = new VBox(label10, certificatesTextField);
        vBox11.setPrefHeight(75);
        vBox11.setPrefWidth(410);
        vBox11.setPadding(new Insets(0, 15, 0, 0));

        Label label11 = new Label("Mức lương");
        label11.setFont(Font.font("System", FontWeight.NORMAL, 20));
        salaryTextField.setPrefHeight(59);
        VBox vBox12 = new VBox(label11, salaryTextField);
        vBox12.setPrefWidth(205);
        vBox12.setPrefHeight(75);
        vBox12.setPadding(new Insets(0, 0, 0, 15));
        ...
        hBox5.setSpacing(30);
        root.getChildren().addAll(hBox, hBox1, hBox2, hBox4, hBox5);
        clearModalStage();
    }
    ...
    public void setUpModalStage(Account teacher){
        createModalStage();
        nameTextField.setText(teacher.getName());
        ageComboBox.setValue(teacher.getAge());
        ...
        addressComboBox.setValue(teacher.getAddress());
        certificatesTextField.setText(teacher.getCertificates());
        salaryTextField.setText(Integer.toString(teacher.getSalary()));
    ...
    public void refreshTeacherTable(ObservableList<Account> TeacherList){
        teacherTable.setItems(TeacherList);
    }

    public void loadTeacherTable(ObservableList<Account> TeacherList){
        teacherTable.setStyle("-fx-background-color: #F5F5F5;");
        teacherTable.setPrefHeight(594);
        teacherTable.setPrefWidth(954);
        teacherTable.setLayoutX(23);
        teacherTable.setLayoutY(107);
        teacherTable.setFixedCellSize(45);

        teacherTable.getColumns().addAll(idCol, nameCol, ageCol, genderCol, emailCol, passCol, phoneCol, addressCol, certificatesCol, salaryCol, statusCol);
    ...
    public void loadBillTable(ObservableList<Bill> BillList){
        ...
        teacherIdCol.setCellValueFactory(new PropertyValueFactory<>("account_id"));
        dateCol.setCellValueFactory(new PropertyValueFactory<>("time"));
        lessonCountCol.setCellValueFactory(new PropertyValueFactory<>("lessonQty"));
        monthlySalaryCol.setCellValueFactory(new PropertyValueFactory<>("total_price"));
    ...
    public void addActionListener(EventHandler<Event> manageTeacherController){
        editHbox.setOnMouseClicked(manageTeacherController);
        deleteHbox.setOnMouseClicked(manageTeacherController);
        addHbox.setOnMouseClicked(manageTeacherController);
        teacherTable.setOnMouseClicked(manageTeacherController);
        confirmHbox.setOnMouseClicked(manageTeacherController);
        updateBillHbox.setOnMouseClicked(manageTeacherController);
    }
}
